 ...
 */
export async function createAwsServiceClients(
  serviceName: ServiceName.SSM,
  idToken: string
): Promise<AWS.SSM>;
export async function createAwsServiceClients(
  serviceName: ServiceName.ResourceGroupsTaggingAPI,
  idToken: string
): Promise<AWS.ResourceGroupsTaggingAPI>;
export async function createAwsServiceClients(
  serviceName: ServiceName,
  idToken: string
): Promise<AWS.STS | AWS.SSM | AWS.ResourceGroupsTaggingAPI> {
