...
export default function Page(): JSX.Element {
  ...
  const [formValues, setFormValues] = React.useState<ChangePasswordFormValues>({
    currentPassword: "",
    newPassword: "",
    confirmNewPassword: ""
  });
  ...
  const [currentPasswordHelperText, setCurrentPasswordHelperText] =
    React.useState<string>(passwordHelperText);
  ...
  const handleSave = async (): Promise<void> => {
    ...
    try {
      ...
      switch (err.name) {
        ...
        default: {
          restoreForm();
          enqueueSnackbar("Error! Couldn't update password.", {
            variant: "error"
          });
          return;
        }
  ...
  return (
    <Layout showSearchBar={false} handleSearchChange={() => ({})}>
